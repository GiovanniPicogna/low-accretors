...
ax[0].vlines(np.median(data_xeuv_03Msun_masked["age"]),0,80,alpha=0.5,color='blue',ls='--')
ax[0].vlines(np.median(data_xeuv_06Msun_masked["age"]),0,80,alpha=0.5,color='green',ls='--')
ax[0].vlines(np.median(data_xeuv_1Msun_masked["age"]),0,80,alpha=0.5,color='orange',ls='--')
...
ax[1].vlines(np.median(data_euv_03Msun_masked["age"]),0,80,alpha=0.5,color='blue',ls='--')
ax[1].vlines(np.median(data_euv_06Msun_masked["age"]),0,80,alpha=0.5,color='green',ls='--')
ax[1].vlines(np.median(data_euv_1Msun_masked["age"]),0,80,alpha=0.5,color='orange',ls='--')
